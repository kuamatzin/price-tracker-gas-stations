...
- [ ] **Task 1: Install and configure Swagger/OpenAPI** (AC: 1)
  - [ ] Install L5-Swagger package: `composer require darkaonline/l5-swagger`
  - [ ] Configure swagger.php with API metadata
  - [ ] Set up auto-generation from annotations
  - [ ] Configure UI theme and branding
  - [ ] Set authentication scheme for Sanctum

- [ ] **Task 2: Document all API endpoints** (AC: 1)
