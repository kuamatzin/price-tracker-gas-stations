...
- [ ] **Task 1: Set up Node.js scraper project structure** (AC: 1)
  - [ ] Initialize Node.js project in apps/scraper/
  - [ ] Configure TypeScript with proper compilation settings
  - [ ] Install required dependencies: got@13.0+, node-postgres, winston, p-limit
  - [ ] Create folder structure: src/scrapers/, src/db/, src/utils/, src/config.ts
