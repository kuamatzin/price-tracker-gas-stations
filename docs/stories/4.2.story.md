...
- [ ] **Task 1: Create Login Page Component** (AC: 1)
  - [ ] Create src/pages/auth/Login.tsx with form layout
...
- [ ] **Task 2: Implement Authentication Store** (AC: 2)
  - [ ] Create src/stores/authStore.ts with Zustand
  - [ ] Store user profile, token, and expiration
  - [ ] Implement login action calling API
  - [ ] Implement logout action with token cleanup
  - [ ] Add token persistence to localStorage
  - [ ] Create isAuthenticated computed property
  - [ ] Handle "Remember Me" preference

- [ ] **Task 3: Set Up Token Management** (AC: 2)
  - [ ] Implement token storage in localStorage
  - [ ] Create token refresh mechanism
  - [ ] Set up refresh timer before expiration
  - [ ] Handle token expiration gracefully
  - [ ] Update Axios interceptors for auto-refresh
  - [ ] Clear tokens on logout
  - [ ] Handle concurrent refresh attempts

- [ ] **Task 4: Create Dashboard Layout Component** (AC: 3, 5)
