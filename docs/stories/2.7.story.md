...
- [ ] **Task 4: Update Existing API Endpoints** (AC: 3, 5)
  - [ ] Add required station_numero parameter to price endpoints
  - [ ] Update analytics queries to filter by station_numero
  - [ ] Modify alert system to be station-specific
  - [ ] Update competitor search to use selected station location
  - [ ] Add station validation middleware
  - [ ] Update API documentation

- [ ] **Task 5: Implement Station Context Middleware** (AC: 3, 5)
  - [ ] Create middleware to extract station_numero from request
  - [ ] Validate user has access to the selected station
  - [ ] Check user's role for the station (owner, manager, viewer)
  - [ ] Add station context to all relevant queries
  - [ ] Return 403 if user lacks access to station
  - [ ] Cache station context in request

- [ ] **Task 6: Update Authentication Response** (AC: 1, 2)
  - [ ] Include user's stations array in login response
  - [ ] Add default selected_station_numero
  - [ ] Include user's role for each station
  - [ ] Update user profile endpoint with stations
  - [ ] Remove old single station field
  - [ ] Update token refresh to maintain station context

- [ ] **Task 7: Create Station Resources** (AC: 2)
  - [ ] Create UserStationResource for API responses
  - [ ] Include station details from stations table
  - [ ] Add user's role for the station
  - [ ] Include full address formatting
  - [ ] Add location data (municipio, entidad)
  - [ ] Optimize eager loading of relationships

- [ ] **Task 8: Add Station-specific Query Scopes** (AC: 5)
  - [ ] Create scopeForStation on Price model
  - [ ] Create scopeForStation on Alert model  
  - [ ] Create scopeForStation on Analytics model
  - [ ] Update existing queries to use station scope
  - [ ] Ensure all data queries filter by station_numero
  - [ ] Add scope documentation

- [ ] **Task 9: Implement Role-based Permissions** (AC: 6)
  - [ ] Define permissions for each role (owner, manager, viewer)
  - [ ] Owners can: manage prices, view analytics, manage alerts
  - [ ] Managers can: view prices, view analytics, view alerts
  - [ ] Viewers can: view prices and basic analytics only
  - [ ] Create policy classes for authorization
  - [ ] Apply policies to API endpoints

- [ ] **Task 10: Update Database Seeders** (AC: 1, 6)
  - [ ] Update UserSeeder to assign stations to test users
  - [ ] Create different role assignments for testing
  - [ ] Assign multiple stations to some test users
  - [ ] Use real station numeros from stations table
  - [ ] Document test user credentials and stations

- [ ] **Task 11: Write Unit Tests** (AC: All)
  - [ ] Test station CRUD operations
  - [ ] Test validation rules
  - [ ] Test user-station relationships
  - [ ] Test station scoping
  - [ ] Test middleware functionality
  - [ ] Test edge cases

- [ ] **Task 12: Write Integration Tests** (AC: 2, 4, 6)
  - [ ] Test complete station creation flow
...
- All tests passing for Tasks 1-3
